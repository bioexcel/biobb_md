...
htmlhelp_basename = 'biobb_md_doc'
...
latex_documents = [
    (master_doc, 'biobb_md.tex', u'biobb_md Documentation',
...
man_pages = [
    (master_doc, 'biobb_md', u'biobb_md Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'biobb_md', u'biobb_md Documentation',
     author, 'biobb_md', 'biobb_md molecular dynamics building blocks',
     'Miscellaneous'),
]
