...
* Installation:
        ...
        conda install -c bioconda "biobb_md>=3.5.0"
...
* Installation:
        ...
        docker pull quay.io/biocontainers/biobb_md:3.5.0--py_0


* Usage:


        docker run quay.io/biocontainers/biobb_md:3.5.0--py_0 <command>
