...
* Installation:
        ...
        conda install -c bioconda "biobb_md>=3.7.0"
...
* Installation:
        ...
        docker pull quay.io/biocontainers/biobb_md:3.7.0--pyhdfd78af_0


* Usage:


        docker run quay.io/biocontainers/biobb_md:3.7.0--pyhdfd78af_0 <command>
