...
class Grompp:
    ...
    Args:
        ...
        input_cpt_path (str) (Optional): Path to the input GROMACS checkpoint file CPT. File type: input. `Sample file <>`_. Accepted formats: cpt (edam:format_2333).
        input_ndx_path (str) (Optional): Path to the input GROMACS index files NDX. File type: input. `Sample file <>`_. Accepted formats: ndx (edam:format_2330).
        input_mdp_path (str) (Optional): Path of the input GROMACS `MDP file <http://manual.gromacs.org/current/user-guide/mdp-options.html>`_. File type: input. `Sample file <>`_. Accepted formats: mdp (edam:format_2330).
